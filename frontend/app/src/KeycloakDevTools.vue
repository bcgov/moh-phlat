<template>
  <div>
    <div class="col1">
      <h2>User Account</h2>
      <v-btn size="small" @click="loadProfile">Get Profile</v-btn>
      <v-btn size="small" @click="updateProfile">Update profile</v-btn>
    </div>
    <div class="col1">
      <h2>Token Information</h2>
      <v-btn size="small" @click="loadUserInfo">Get User Info</v-btn>
      <v-btn size="small" @click="showToken">Show Token</v-btn>
      <v-btn size="small" @click="showRefreshToken">Show Refresh Token</v-btn>
      <v-btn size="small" @click="showIdToken">Show ID Token</v-btn>
      <v-btn size="small" @click="showExpires">Show Expires</v-btn>
      <v-btn size="small" @click="showDetails">Show Details</v-btn>
    </div>
    <div class="col4">
