...
public class ProcessDataFactory extends BaseFactory {
    ...
    private static Message createMessageData(Long id, String messageType, String messageCode,
                                             String messageDesc, String sourceSystemName, String sourceSystemMessageCode,
                                             String sourceSystemMessageDesc, String sourceSystemMessageType) {
        ...
        return Message.builder()
                ...
                .sourceSystemMessageCode(sourceSystemMessageCode)
                .sourceSystemMessageDesc(sourceSystemMessageDesc)
                .sourceSystemMessageType(sourceSystemMessageType)
                .build();
    }

    public static List<Message> createMessageDataList() {
        List<Message> messages = new ArrayList<>();

        messages.add(createMessageData(11L, "WARNING", "PRS.SYS.ADR.UNK.1.0.1111",
                "An existing facility address was found, can not create duplicate facility. IFC.0000001.BC.PRS", null, null, null, null));
        messages.add(createMessageData(22L, "ERROR", "PRS.SYS.ADR.UNK.1.0.2222",
                "Can not create duplicate.", null, null, null, null));
        messages.add(createMessageData(33L, "WARNING", "PRS.SYS.ADR.UNK.1.0.3333",
                "System Warning", null, null, null, null));
        messages.add(createMessageData(44L, "ERROR", "PRS.SYS.ADR.UNK.1.0.4444",
                "System Error", null, null, null, null));
        return messages;
    }


    private static ProcessData createProcessDataWithMessages(Long id, Long controlTableId, String doNotLoad, String stakeholder, String stakeholderId,
                                                             String hdsIpcId, String hdsCpnId,
                                                             String hdsProviderIdentifier1,
                                                             String hdsProviderIdentifier2, String hdsProviderIdentifier3,
                                                             String hdsProviderIdentifierType1, String hdsProviderIdentifierType2,
                                                             ...
                                                             String mailAddrPrpsTypeCd, String mailAddrValidationStatus,
                                                             String plrFacilityId, String rowstatusCode,
                                                             Date createdAt, String createdBy, Date updatedAt, String updatedBy, List<Message> messages) {
    ...
    public static List<ProcessData> createProcessDataListWithMessages() {
        List<ProcessData> processData = new ArrayList<>();

        processData.add(createProcessDataWithMessages(2L, 2L, "N", "HOSPITAL", "stakeholderid_1",
                "IpcId_1", "CpnId_1",
                "identifier1_1", "identifier2_1", "identifier3_1",
                "identType1_1", "identType2_1",
                "identType3_1", "mspFacilityNumber_1",
                "pauth_lysonle", "catCode_1", "roleTypeCode_1",
                "hdsType_2", "hdsSubType_2",
                "lysone@0001", "2024-05-27", "3000-12-31", "hdsNameCC",
                "N", "test@example.com", "www.test.com",
                "456", "1234567", "ext456",
                "789", "0123456", "fax456", "1234567",
                "pcdServiceDeliveryType_2",
                ...
                "PRPS1", "Invalid", "1000000", "VALID",
                createDate(2024, Calendar.FEBRUARY, 1), "Admin2",
                createDate(2024, Calendar.FEBRUARY, 2), "Admin3", createMessageDataList()));


        processData.add(createProcessDataWithMessages(3L, 3L, "Y", "RESIDENTAL CARE", "stakeholderid02",
                "IpcId321", "CpnId654",
                "identifier1_2", "identifier2_2", "identifier3_2",
                "identType1_2", "identType2_2",
                "identType3_2", "mspFacilityNumber2",
                "pauth_lyson", "catCode_2", "roleTypeCode_2",
                "hdsType_2", "hdsSubType_2",
                "lysone@0001", "2024-05-27", "3000-12-31", "hdsNameAA",
                "N", "test@example.com", "www.test.com",
                "456", "1234567", "ext456",
                "789", "0123456", "fax456", "1234567",
                "pcdServiceDeliveryType_2",
        ...
        processData.add(createProcessDataWithMessages(1L, 2L, "N", "HOSPITAL", "stakeholderid_1",
                "IpcId_1", "CpnId_1",
                "identifier1_1", "identifier2_1", "identifier3_1",
                "identType1_1", "identType2_1",
                "identType3_1", "mspFacilityNumber_1",
                "pauth_lysonle", "catCode_1", "roleTypeCode_1",
                "hdsType_2", "hdsSubType_2",
                "lysone@0001", "2024-05-27", "3000-12-31", "hdsNameBB",
                "N", "test@example.com", "www.test.com",
                "456", "1234567", "ext456",
                "789", "0123456", "fax456", "1234567",
                "pcdServiceDeliveryType_2",
    ...
    public static List<ProcessData> createProcessDataListWithMessagesFacilityCivicAddress() {
        List<ProcessData> processData = new ArrayList<>();
